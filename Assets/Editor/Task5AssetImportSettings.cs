...
public sealed class Task5AssetImportSettings : AssetPostprocessor
{
    ...
    private void OnPreprocessTexture()
    {
        ...
        bool isTreeSprite = assetPath.Contains("/Environment/tree_");
        bool isDecorSprite = assetPath.Contains("/Environment/decor_");
        bool isEnvironmentSprite = isTreeSprite || isDecorSprite;
        ...
        importer.spritePixelsPerUnit = isTreeSprite ? 256f : 64f;
